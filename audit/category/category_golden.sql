...
-- ---- GAP: известные открытые дыры (NEW-1/NEW-2 бэклог; ожидаемо красные) -----
('Кронштейн для видеокарты вертикальный',         null, 'other',    true,  'NEW-1',      'gap', 'аксессуар → сейчас утекает в gpu (нет гарда «кронштейн»)'),
('Термопрокладки для видеокарты 2мм 12шт',        null, 'other',    true,  'NEW-1',      'gap', 'термопрокладки → сейчас gpu'),
('Рамка сокета LGA 1700 для процессора',          null, 'other',    true,  'NEW-1',      'gap', 'рамка сокета → сейчас mobo (есть «сокет»/lga)'),
('Бэкплейт для видеокарты усиленный',             null, 'other',    true,  'NEW-1',      'gap', 'бэкплейт → сейчас gpu'),
('Накопитель Crucial MX500 500GB',                null, 'ssd',      false, 'NEW-2',      'gap', 'SSD без слова ssd/nvme/evo → сейчас other (неполный словарь)');
