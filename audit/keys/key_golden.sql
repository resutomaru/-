...
('ram','Kingston Fury Beast DDR5 32GB 6000',null,null,'ddr5-32gb-6000-prem',true,'PREM','regression','премиум-линейка Fury → -prem тир (20.06)'),
...
('ram','DDR5 2x24GB 6000 G.Skill',null,null,'ddr5-48gb-6000-prem',true,'E8','regression','кит-тотал 48 в allowlist; G.Skill→-prem тир'),
...
('ram','Оперативная память HyperX ddr4 1x16 2666Hz',null,null,'ddr4-16gb-2666-prem',true,'Hz-unit','regression','Hz-частота + HyperX премиум → -prem тир'),
('ram','Оперативная память ADATA XPG ddr4 16gb 3200',null,null,'ddr4-16gb-3200-prem',true,'PREM','regression','премиум XPG → тир в ключ (generic≠premium)'),
('ram','Оперативная память ddr4 16gb generic',null,null,'ddr4-16gb',false,'PREM','regression','дженерик без бренда — бакет ddr4-16gb БЕЗ prem (контроль)'),
